...
class PagesController extends Controller
{
    public function index(){
        ...
        $cities = City::orderBy('popularity', 'desc')->take(4)->get();

        return view('welcome')->with('news', $news)->with('places', $places)->with('posts', $posts)->with('cities', $cities);
    ...
    public function dashboard(){
        ...
        // Add cities per user in the dashboard
        $user = Auth::user();
        ...
        return view('dashboard')->with('posts', $posts)->with('cities', $cities)
